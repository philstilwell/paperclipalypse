...
Run: 2026-06-04-ext-real-2026-06-05
Winner: Gemini Flash
Winning joke: Thermal Journey
...
Optional small header text above the panel: Winner: Gemini Flash - Thermal Journey
...
Seed terms for visual motifs: Young adult/Kids, Politician, Spa, A house fire, Unselfish, Impulsive.
...
```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-05.json --feature-image /absolute/path/to/approved-image.png --feature-image-qa-approved
```
