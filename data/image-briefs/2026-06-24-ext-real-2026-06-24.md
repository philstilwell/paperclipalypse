...
Run: 2026-06-24-ext-real-2026-06-24
Winner: Claude Sonnet 4.6
Winning joke: The Rejection Letter
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - The Rejection Letter
Exact joke text to render in the right panel:
I got cut from a community garden. A garden. They said I lacked 'commitment to the collective vision.' I got a letter. With bullet points. My sunflowers were 'inconsistent,' my zucchini showed 'poor spacing awareness.' I didn't even know you could get benched by vegetables. But honestly? Warms my heart knowing somewhere out there, a zucchini is telling the story of the guy it cut.
...
Seed terms for visual motifs: Body and Extreme, Painter, Flower Garden, Being cut from a team, Disciplined, Inattentive.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-24-ext-real-2026-06-24.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-24.json --feature-image tmp/gemini-feature-images/2026-06-24-ext-real-2026-06-24.jpg --feature-image-qa-approved
```
