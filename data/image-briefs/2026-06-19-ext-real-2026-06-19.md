...
Run: 2026-06-19-ext-real-2026-06-19
Winner: Gemini Flash
Winning joke: Unearned Swagger
...
Optional small header text above the panel: Winner: Gemini Flash - Unearned Swagger
Exact joke text to render in the right panel:
I try to act incredibly cocky on dates. Unearned swagger. But the illusion completely shatters the second I bring someone back to my run-down apartment. It is physically impossible to lean in, make smoldering eye contact, and smoothly whisper, 'I want you,' right after saying, 'Hold on, let me jiggle the toilet handle so the screaming stops.'
...
Seed terms for visual motifs: Billionaires, Salesperson, Run-down Apartment, Indulging when you shouldn't, Professional, Cocky.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-19-ext-real-2026-06-19.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-19.json --feature-image tmp/gemini-feature-images/2026-06-19-ext-real-2026-06-19.jpg --feature-image-qa-approved
```
