...
Run: 2026-07-12-ext-real-2026-07-12
Winner: OpenAI GPT-5.4 Mini
Winning joke: The Missing Lid
...
Optional small header text above the panel: Winner: OpenAI GPT-5.4 Mini - The Missing Lid
Exact joke text to render in the right panel:
I took a pottery class. The guy beside me said, “The secret is more speed,” so I cranked the wheel. My bowl launched across the room and landed upside down on his. Turns out he wasn’t the instructor—he’d just been waiting for someone to make him a lid.
...
Round seed terms for exclusion reference only: Caper, Glassblower / Potter, Subway Train / Station / Tunnel, Taking advice from the wrong person, Loyal, Foolish. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-12-ext-real-2026-07-12.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-12.json --feature-image tmp/gemini-feature-images/2026-07-12-ext-real-2026-07-12.jpg --feature-image-qa-approved
```
