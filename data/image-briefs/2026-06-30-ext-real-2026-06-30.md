...
Run: 2026-06-30-ext-real-2026-06-30
Winner: Claude Sonnet 4.6
Winning joke: Murder, But Make It Cozy
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Murder, But Make It Cozy
Exact joke text to render in the right panel:
I hired an assassin off an app, and I should've known something was off when his profile picture was him in a knitted sweater holding a mug that said 'World's Okayest Killer.' He showed up to the hit twenty minutes late because he stopped to make us both tea. He didn't even bring a real weapon, just kept asking my enemy really pointed questions about his choices. Guy didn't die, he just cried for an hour and rearranged his whole life. I paid full price for a stabbing and got a wellness check.
...
Seed terms for visual motifs: Cozy and Amateur, Assassin, Rainforest, A natural disaster, Optimistic, Resentful.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-30-ext-real-2026-06-30.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-30.json --feature-image tmp/gemini-feature-images/2026-06-30-ext-real-2026-06-30.jpg --feature-image-qa-approved
```
