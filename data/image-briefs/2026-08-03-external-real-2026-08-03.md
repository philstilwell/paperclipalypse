...
Run: 2026-08-03-external-real-2026-08-03
Winner: Claude Sonnet 4.6
Winning joke: Man Bun Emergency
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Man Bun Emergency
...
Round seed terms for exclusion reference only: Children, Firefighter, Hair Salon, A way of life being threatened, Friendly, Fanatical. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-03-external-real-2026-08-03.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-03.json --feature-image tmp/gemini-feature-images/2026-08-03-external-real-2026-08-03.jpg --feature-image-qa-approved
```
