...
Run: 2026-07-31-ext-real-2026-07-31
Winner: Gemini Flash
Winning joke: Apocalypse Group Text
...
Optional small header text above the panel: Winner: Gemini Flash - Apocalypse Group Text
Exact joke text to render in the right panel:
I realized I wouldn't survive an alien invasion, mostly because I absolutely hate having to rely on others. I’m not joining your ragtag band of apocalypse survivors. The minute some guy named Rick says, “We have to stick together,” I'm walking directly into the tractor beam. I would literally rather be vaporized than participate in a group text to figure out who's bringing the ammo.
...
Round seed terms for exclusion reference only: Alien Invasion, Nanny, Patio, Having to rely on others, Enthusiastic, Judgmental. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-31-ext-real-2026-07-31.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-31.json --feature-image tmp/gemini-feature-images/2026-07-31-ext-real-2026-07-31.jpg --feature-image-qa-approved
```
