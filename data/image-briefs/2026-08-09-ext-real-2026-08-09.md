...
Run: 2026-08-09-ext-real-2026-08-09
Winner: xAI Grok 4.3
Winning joke: Island Red Alert
...
Optional small header text above the panel: Winner: xAI Grok 4.3 - Island Red Alert
Exact joke text to render in the right panel:
I booked a last-minute trip to a tropical island and showed up completely unprepared. Three pairs of wool socks, zero sunscreen, one blazer. By day two I was so red the kids on the beach kept circling me with sticks, trying to roast marshmallows off my shoulders.
...
Round seed terms for exclusion reference only: Haunting, Server, Tropical Island, Being unprepared, Disciplined, Nervous. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-09-ext-real-2026-08-09.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-08-09.json --feature-image tmp/gemini-feature-images/2026-08-09-ext-real-2026-08-09.jpg --feature-image-qa-approved
```
