...
Run: 2026-06-16-ext-real-2026-06-16
Winner: Gemini Flash
Winning joke: Superhuman Strength
...
Optional small header text above the panel: Winner: Gemini Flash - Superhuman Strength
...
Seed terms for visual motifs: Bumbling Detective, Manual Labourer, Boardroom, A loved one being put in harm's way, Playful, Lazy.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-16-ext-real-2026-06-16.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-16.json --feature-image tmp/gemini-feature-images/2026-06-16-ext-real-2026-06-16.jpg --feature-image-qa-approved
```
