...
Run: 2026-06-25-ext-real-2026-06-25
Winner: Gemini Flash
Winning joke: Tuesday Morning
...
Optional small header text above the panel: Winner: Gemini Flash - Tuesday Morning
...
Seed terms for visual motifs: Portal, Prostitute, Backyard, A fear or phobia rearing its head, Protective, Apathetic.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-25-ext-real-2026-06-25.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-25.json --feature-image tmp/gemini-feature-images/2026-06-25-ext-real-2026-06-25.jpg --feature-image-qa-approved
```
