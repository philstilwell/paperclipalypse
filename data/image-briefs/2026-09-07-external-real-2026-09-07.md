...
Run: 2026-09-07-external-real-2026-09-07
Winner: OpenAI GPT-5.6 Sol
Winning joke: Judicial Restraint
...
Optional small header text above the panel: Winner: OpenAI GPT-5.6 Sol - Judicial Restraint
...
Round seed terms for exclusion reference only: Wilderness, Judge, Wedding Reception, Being trapped, Independent, Scatterbrained. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-07-external-real-2026-09-07.md
```

Read the generated `tmp/gemini-feature-images/2026-09-07-external-real-2026-09-07.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-07-external-real-2026-09-07.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-07.json --feature-image tmp/gemini-feature-images/2026-09-07-external-real-2026-09-07.jpg --feature-image-qa-approved
```
