...
Run: 2026-08-01-ext-real-2026-08-01
Winner: Contestant 3
Winning joke: Aggressive Brunch
...
Optional small header text above the panel: Winner: Contestant 3 - Aggressive Brunch
Exact joke text to render in the right panel:
I get weirdly defensive in bakeries. The teenager at the counter asked if my dozen eclairs were for a special occasion. I immediately crossed my arms and snapped, "They're for a party." He looked at my sweatpants and said, "At 8 AM on a Tuesday?" I stared him down and said, "It's a very aggressive brunch, Kevin, just box the pastries and mind your own business."
...
Round seed terms for exclusion reference only: Achieve Potential, Inventor, Bakery, Losing a bet, Studious, Defensive. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-01-ext-real-2026-08-01.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-08-01.json --feature-image tmp/gemini-feature-images/2026-08-01-ext-real-2026-08-01.jpg --feature-image-qa-approved
```
