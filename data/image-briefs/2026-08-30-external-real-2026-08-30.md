...
Run: 2026-08-30-external-real-2026-08-30
Winner: OpenAI GPT-5.4 Mini
Winning joke: Pick a Card
...
Optional small header text above the panel: Winner: OpenAI GPT-5.4 Mini - Pick a Card
Exact joke text to render in the right panel:
I saw a street magician who kept asking me to pick a card. I said no three times. On the fourth, he said, “Fine—just think of one.” I walked away. He followed me for two blocks shouting guesses. I’ve never seen a man turn “Is this your card?” into a restraining-order application.
...
Round seed terms for exclusion reference only: Cozy and Amateur, Street Performer, Farm, Being offered dirty money, Persistent, Disloyal. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-08-30-external-real-2026-08-30.md
```

Read the generated `tmp/gemini-feature-images/2026-08-30-external-real-2026-08-30.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-30-external-real-2026-08-30.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-30.json --feature-image tmp/gemini-feature-images/2026-08-30-external-real-2026-08-30.jpg --feature-image-qa-approved
```
