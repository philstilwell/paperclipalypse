...
Run: 2026-07-07-ext-real-2026-07-07
Winner: Gemini Flash
Winning joke: The Crypto Florist
...
Optional small header text above the panel: Winner: Gemini Flash - The Crypto Florist
Exact joke text to render in the right panel:
I lost my entire life savings in crypto last year. Went from a high-rise corner office to arranging bouquets at a local flower shop. My parents are devastated by the drop in prestige, but honestly? The business model is exactly the same. Guys come in in a total panic, hand me way too much money, and I give them something that's guaranteed to be dead in three days.
...
Round seed terms for exclusion reference only: Lawmen, Animal Groomer, Flower Shop, A loss of prestige or wealth, Ambitious, Evil. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-07-ext-real-2026-07-07.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-07.json --feature-image tmp/gemini-feature-images/2026-07-07-ext-real-2026-07-07.jpg --feature-image-qa-approved
```
