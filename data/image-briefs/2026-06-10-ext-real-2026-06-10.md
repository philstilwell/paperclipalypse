...
Run: 2026-06-10-ext-real-2026-06-10
Winner: Claude Sonnet 4.6
Winning joke: Too Polite to Panic
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Too Polite to Panic
...
Seed terms for visual motifs: Political Change, Radio Presenter, Empty Lot, Getting lost / stranded, Courteous, Suspicious.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-10-ext-real-2026-06-10.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-10.json --feature-image tmp/gemini-feature-images/2026-06-10-ext-real-2026-06-10.jpg --feature-image-qa-approved
```
