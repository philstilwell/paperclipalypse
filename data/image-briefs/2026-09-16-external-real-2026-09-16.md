...
Run: 2026-09-16-external-real-2026-09-16
Winner: xAI Grok
Winning joke: Past Due Labor
...
Optional small header text above the panel: Winner: xAI Grok - Past Due Labor
Exact joke text to render in the right panel:
I found a mechanic who does time travel. My car wouldn't start, he hops in his van, vanishes, comes back, and it runs perfect. Then he bills me for six hours. I go, 'You were gone twelve minutes!' He says, 'Sure, but I spent six hours in 1955 waiting for the parts to be invented.'
...
Round seed terms for exclusion reference only: Time Travel, Mechanic, Kitchen, Conflicting internal needs or desires, Talented, Hostile. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-16-external-real-2026-09-16.md
```

Read the generated `tmp/gemini-feature-images/2026-09-16-external-real-2026-09-16.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-16-external-real-2026-09-16.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-16.json --feature-image tmp/gemini-feature-images/2026-09-16-external-real-2026-09-16.jpg --feature-image-qa-approved
```
