...
Run: 2026-06-28-ext-real-2026-06-28
Winner: Gemini Flash
Winning joke: Roadside Assistance
...
Optional small header text above the panel: Winner: Gemini Flash - Roadside Assistance
...
Seed terms for visual motifs: Billionaires, Real Estate Agent, Flower Shop, Having to decide to help or do not, Disciplined, Gullible.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-28-ext-real-2026-06-28.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-28.json --feature-image tmp/gemini-feature-images/2026-06-28-ext-real-2026-06-28.jpg --feature-image-qa-approved
```
