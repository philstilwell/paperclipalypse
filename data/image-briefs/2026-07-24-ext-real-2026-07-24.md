...
Run: 2026-07-24-ext-real-2026-07-24
Winner: Gemini Flash
Winning joke: Occupational Hazards
...
- Show the casket physically open in a believable way: the coffin base contains the deceased, and the lid is either raised clearly behind the body or swung fully away from the widow.
- The widow must be outside the coffin, leaning in from the side or above the open base. She must not be wedged, trapped, or visually sandwiched between the coffin lid and the coffin base.
- No human body part should pass through the coffin lid, hinge area, or coffin rim. The woman cannot occupy the gap between the top and bottom halves of the casket.
- The dead husband must remain fully inside the lower coffin base while the widow leans in to kiss him.
- The dead man's Apple Watch must be clearly visible on his wrist, and the announced phrase must visibly originate from that watch.
- If you show a speech bubble or sound bubble for the line “It looks like you’ve taken a hard fall.”, its tail must point directly to the Apple Watch on the corpse's wrist, not to the widow, not to the husband’s mouth, and not to empty air.
- Make the watch look like it is actively speaking or chiming: show a lit screen, tiny sound lines, or a glow coming from the watch itself.
...
Visible text allowed in the entire image: the right-panel joke text, the watch's spoken line if shown as a bubble, a tiny stage sign reading Paperclipalypse, and optionally a small winner/title header above the panel.
...
Optional small header text above the panel: Winner: Gemini Flash - Occupational Hazards
Exact joke text to render in the right panel:
I’m a funeral director, and the hardest part of my job isn’t the grief. It’s the cringe. Last Tuesday we had this beautiful, perfectly silent viewing. The weeping widow leans over the open casket to kiss her husband one last time... and from deep inside his suit jacket, his Apple Watch loudly announces, “It looks like you’ve taken a hard fall.”
...
Round seed terms for exclusion reference only: Cringe, Funeral Director / Undertaker, Forest, An opportunity to cheat, Organized, Inattentive. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-24-ext-real-2026-07-24.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-24.json --feature-image tmp/gemini-feature-images/2026-07-24-ext-real-2026-07-24.jpg --feature-image-qa-approved
```
