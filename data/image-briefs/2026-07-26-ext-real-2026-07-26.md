...
Run: 2026-07-26-ext-real-2026-07-26
Winner: Gemini Flash
Winning joke: The Shy Ghost
...
Optional small header text above the panel: Winner: Gemini Flash - The Shy Ghost
Exact joke text to render in the right panel:
I recently discovered my apartment is haunted, but luckily, the ghost is incredibly introverted. He doesn't rattle heavy chains or violently slam doors—he just quietly clears his throat when I'm standing in front of the microwave. Last night, the TV turned on by itself at 3 AM, but it was on mute with the closed captions running so he wouldn't wake me up. I'm not even scared of the afterlife anymore, I'm just stressed about having to make small talk in the hallway.
...
Round seed terms for exclusion reference only: Paranormal, Bartender, Liquor Store, A fear or phobia rearing its head, Introverted, Perfectionist. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-26-ext-real-2026-07-26.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-26.json --feature-image tmp/gemini-feature-images/2026-07-26-ext-real-2026-07-26.jpg --feature-image-qa-approved
```
