...
Run: 2026-07-10-ext-real-2026-07-10
Winner: Claude Sonnet 4.6
Winning joke: Wine Guy
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Wine Guy
...
Round seed terms for exclusion reference only: Locked Room, Vintner, Ancient Ruins, Being insulted, Adventurous, Evil. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-10-ext-real-2026-07-10.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-10.json --feature-image tmp/gemini-feature-images/2026-07-10-ext-real-2026-07-10.jpg --feature-image-qa-approved
```
