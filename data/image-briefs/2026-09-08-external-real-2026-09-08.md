...
Run: 2026-09-08-external-real-2026-09-08
Winner: Gemini Flash
Winning joke: Post-Game Presser
...
Optional small header text above the panel: Winner: Gemini Flash - Post-Game Presser
...
Round seed terms for exclusion reference only: Alien Invasion, Professional Athlete, Bazaar, Being assigned a dangerous task, Honorable, Evasive. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-08-external-real-2026-09-08.md
```

Read the generated `tmp/gemini-feature-images/2026-09-08-external-real-2026-09-08.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-08-external-real-2026-09-08.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-08.json --feature-image tmp/gemini-feature-images/2026-09-08-external-real-2026-09-08.jpg --feature-image-qa-approved
```
