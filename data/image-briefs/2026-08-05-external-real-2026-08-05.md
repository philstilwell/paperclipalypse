...
Run: 2026-08-05-external-real-2026-08-05
Winner: Gemini Flash
Winning joke: The Illusionist
...
Optional small header text above the panel: Winner: Gemini Flash - The Illusionist
Exact joke text to render in the right panel:
I briefly tried working as a kids' party magician, but it turns out I’m way too temperamental for the gig. You can only have a sticky seven-year-old scream, 'I saw the quarter go up your sleeve!' so many times before you completely snap. I just leaned in and whispered, 'Yeah? Well I saw your dad crying in the Kia Sorento, Tyler. Looks like the illusion is shattered for both of us.'
...
Round seed terms for exclusion reference only: Alt. and Parallel Universe, Kids Entertainer, Country Fair, A partner / friend racking up debt, Hospitable, Temperamental. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-05-external-real-2026-08-05.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-05.json --feature-image tmp/gemini-feature-images/2026-08-05-external-real-2026-08-05.jpg --feature-image-qa-approved
```
