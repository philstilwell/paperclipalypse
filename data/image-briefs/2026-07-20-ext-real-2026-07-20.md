...
Run: 2026-07-20-ext-real-2026-07-20
Winner: Claude Sonnet 4.6
Winning joke: Camp Rules
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Camp Rules
...
Round seed terms for exclusion reference only: Utopia, Conductor, Summer Camp, Sacrificing ethics for greater good, Independent, Suspicious. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-20-ext-real-2026-07-20.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-20.json --feature-image tmp/gemini-feature-images/2026-07-20-ext-real-2026-07-20.jpg --feature-image-qa-approved
```
