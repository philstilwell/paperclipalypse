...
Run: 2026-08-08-ext-real-2026-08-08
Winner: Gemini Flash
Winning joke: Keep You Around
...
Optional small header text above the panel: Winner: Gemini Flash - Keep You Around
Exact joke text to render in the right panel:
Breaking up is hard, but it's a lot more stressful when your ex is a taxidermist. Because when she cries, looks you in the eye, and says, 'I just want to keep you around forever,' it completely loses the romance. It just makes you wonder if she's already picked out your glass eyes.
...
Round seed terms for exclusion reference only: Conspiracy, Taxidermist, Convenience Store, A divorce / breakup / falling out, Ambitious, Know-It-All. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-08-ext-real-2026-08-08.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-08-08.json --feature-image tmp/gemini-feature-images/2026-08-08-ext-real-2026-08-08.jpg --feature-image-qa-approved
```
