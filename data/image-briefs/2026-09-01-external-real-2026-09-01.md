...
Run: 2026-09-01-external-real-2026-09-01
Winner: OpenAI GPT-5.4 Mini
Winning joke: Exonerated
...
Optional small header text above the panel: Winner: OpenAI GPT-5.4 Mini - Exonerated
...
Round seed terms for exclusion reference only: Workout, Private Detective, Landfill, Being framed, Unselfish, Cruel. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-01-external-real-2026-09-01.md
```

Read the generated `tmp/gemini-feature-images/2026-09-01-external-real-2026-09-01.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-01-external-real-2026-09-01.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-01.json --feature-image tmp/gemini-feature-images/2026-09-01-external-real-2026-09-01.jpg --feature-image-qa-approved
```
