...
Run: 2026-06-21-ext-real-2026-06-21
Winner: Claude Sonnet 4.6
Winning joke: The Substitute Carrier
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - The Substitute Carrier
Exact joke text to render in the right panel:
My mail carrier got replaced for two weeks by a substitute who was clearly new and deeply indecisive. I'd watch him stand at my mailbox for like ninety seconds, just holding my electric bill, looking at it like it had asked him out. One day he didn't deliver anything. He just left a sticky note that said “thinking about it.”
...
Seed terms for visual motifs: Feel-Good, Mail Carrier, Nursery, A competitor showing up, Cautious, Indecisive.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-21-ext-real-2026-06-21.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-21.json --feature-image tmp/gemini-feature-images/2026-06-21-ext-real-2026-06-21.jpg --feature-image-qa-approved
```
