...
Run: 2026-09-12-external-real-2026-09-12
Winner: Gemini Flash
Winning joke: Bodyguard Reflex
...
Optional small header text above the panel: Winner: Gemini Flash - Bodyguard Reflex
...
Round seed terms for exclusion reference only: Mystery, Secret Service Agent, Ice Cream Parlor, Hurting someone to save them, Analytical, Needy. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-12-external-real-2026-09-12.md
```

Read the generated `tmp/gemini-feature-images/2026-09-12-external-real-2026-09-12.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-12-external-real-2026-09-12.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-12.json --feature-image tmp/gemini-feature-images/2026-09-12-external-real-2026-09-12.jpg --feature-image-qa-approved
```
