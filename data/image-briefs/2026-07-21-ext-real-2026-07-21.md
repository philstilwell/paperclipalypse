...
Run: 2026-07-21-ext-real-2026-07-21
Winner: Claude Sonnet 4.6
Winning joke: Nap Time Bounty
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Nap Time Bounty
Exact joke text to render in the right panel:
I babysit my nephew for extra cash, but I run it like a bounty hunter. I don't say 'bedtime,' I say 'target's last known location: the couch.' Kid negotiates like a hostage. 'Ten more minutes or I tell Mom you were on your phone.' Fine, I say, twenty bucks, dead or asleep. Last week he escaped through the doggy door. I don't do this for the money anymore. I do it for the thrill of the chase.
...
Round seed terms for exclusion reference only: Bounty Hunters, Babysitter, Airplane / Airport, A house fire, Studious, Temperamental. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-21-ext-real-2026-07-21.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-21.json --feature-image tmp/gemini-feature-images/2026-07-21-ext-real-2026-07-21.jpg --feature-image-qa-approved
```
