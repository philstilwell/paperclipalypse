...
Run: 2026-07-03-ext-real-2026-07-03
Winner: Gemini Flash
Winning joke: Unsolicited Feedback
...
Optional small header text above the panel: Winner: Gemini Flash - Unsolicited Feedback
...
Seed terms for visual motifs: War and Military, Firefighter, House Fire, Being bullied, Spunky, Confrontational.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-03-ext-real-2026-07-03.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-03.json --feature-image tmp/gemini-feature-images/2026-07-03-ext-real-2026-07-03.jpg --feature-image-qa-approved
```
