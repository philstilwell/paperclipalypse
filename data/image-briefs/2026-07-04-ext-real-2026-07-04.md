...
Run: 2026-07-04-ext-real-2026-07-04
Winner: Gemini Flash
Winning joke: Situational Fame
...
Optional small header text above the panel: Winner: Gemini Flash - Situational Fame
Exact joke text to render in the right panel:
People talk about the thrill of being recognized. Trust me, it's highly situational. It’s flattering if you’re an actor at a premiere. It is absolutely devastating when you walk into an airport Chili's at 10 AM on a Tuesday, and the bartender instantly shouts, 'The usual bucket of wings, Phil?!' That’s not fame, Kevin. That’s a cry for help.
...
Seed terms for visual motifs: Sports, Bartender, Art Gallery, Being recognized, Extroverted, Sleazy.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-04-ext-real-2026-07-04.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-04.json --feature-image tmp/gemini-feature-images/2026-07-04-ext-real-2026-07-04.jpg --feature-image-qa-approved
```
