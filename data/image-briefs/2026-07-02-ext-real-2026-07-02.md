...
Run: 2026-07-02-ext-real-2026-07-02
Winner: Claude Sonnet 4.6
Winning joke: Open House
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Open House
Exact joke text to render in the right panel:
I hired a real estate agent to sell my house, and this woman is tactless in a way that feels almost professional. Walked a couple through my living room and said, 'Ignore the smell, that's just failure.' They asked about the neighborhood. She goes, 'Quiet. Nobody talks to each other after what happened.' I'm standing right there. She turned to me and whispered, 'Don't worry, I'm rounding down your asking price and up your personality.' The couple left. She turned to me and said, 'They're not ready for a house like you.'
...
Seed terms for visual motifs: Cringe, Real Estate Agent, Empty Lot, Not achieving a coveted goal, Kind, Tactless.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-02-ext-real-2026-07-02.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-02.json --feature-image tmp/gemini-feature-images/2026-07-02-ext-real-2026-07-02.jpg --feature-image-qa-approved
```
