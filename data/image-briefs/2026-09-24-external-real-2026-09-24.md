...
Run: 2026-09-24-external-real-2026-09-24
Winner: Copilot
Winning joke: Prototype Parent
...
Optional small header text above the panel: Winner: Copilot - Prototype Parent
...
Round seed terms for exclusion reference only: Herding, Inventor, Office Cubicle, Having to stay behind, Loyal, Impatient. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-24-external-real-2026-09-24.md
```

Read the generated `tmp/gemini-feature-images/2026-09-24-external-real-2026-09-24.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-24-external-real-2026-09-24.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-24.json --feature-image tmp/gemini-feature-images/2026-09-24-external-real-2026-09-24.jpg --feature-image-qa-approved
```
