...
Run: 2026-07-28-ext-real-2026-07-28
Winner: OpenAI GPT-5.4 Mini
Winning joke: The Deductible
...
Optional small header text above the panel: Winner: OpenAI GPT-5.4 Mini - The Deductible
Exact joke text to render in the right panel:
I took my nephew to a skate park and told him, “I used to do this.” He handed me a board. One push in, my lower back seized so hard I had to lie flat on the concrete. The kids were impressed. They thought I’d invented a trick called “the deductible.”
...
Round seed terms for exclusion reference only: Fairy Tale, Secret Service Agent, Skate Park, A health issue cropping up, Sentimental, Martyr. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-28-ext-real-2026-07-28.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-28.json --feature-image tmp/gemini-feature-images/2026-07-28-ext-real-2026-07-28.jpg --feature-image-qa-approved
```
