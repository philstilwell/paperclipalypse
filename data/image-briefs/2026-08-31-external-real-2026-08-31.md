...
Run: 2026-08-31-external-real-2026-08-31
Winner: OpenAI GPT-5.4 Mini
Winning joke: Forty Years
...
Optional small header text above the panel: Winner: OpenAI GPT-5.4 Mini - Forty Years
Exact joke text to render in the right panel:
I built a time machine and went back to summer camp to stop myself from performing in the talent show. I told twelve-year-old me, “Trust me, this will embarrass you for forty years.” He lit up: “I live past fifty?” Then he ran onstage like I’d just given him a standing ovation.
...
Round seed terms for exclusion reference only: Time Travel, Therapist, Summer Camp, Being manipulated, Charming, Humorless. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-08-31-external-real-2026-08-31.md
```

Read the generated `tmp/gemini-feature-images/2026-08-31-external-real-2026-08-31.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-31-external-real-2026-08-31.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-31.json --feature-image tmp/gemini-feature-images/2026-08-31-external-real-2026-08-31.jpg --feature-image-qa-approved
```
