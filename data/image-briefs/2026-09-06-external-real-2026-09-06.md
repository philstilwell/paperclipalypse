...
Run: 2026-09-06-external-real-2026-09-06
Winner: Gemini Flash
Winning joke: The Movers
...
Optional small header text above the panel: Winner: Gemini Flash - The Movers
Exact joke text to render in the right panel:
I hired professional movers last week, mostly because I have a crippling phobia of eye contact with my friends. If you pay two guys named Vlad three hundred dollars, you don't have to pretend you're going to help carry the sleeper sofa. You can just stand in the driveway holding a single framed photo of your dog like an evacuee.
...
Round seed terms for exclusion reference only: Alt. and Parallel Universe, Removalist, Prison Cell, A fear or phobia rearing its head, Socially Aware, Forgetful. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-06-external-real-2026-09-06.md
```

Read the generated `tmp/gemini-feature-images/2026-09-06-external-real-2026-09-06.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-06-external-real-2026-09-06.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-06.json --feature-image tmp/gemini-feature-images/2026-09-06-external-real-2026-09-06.jpg --feature-image-qa-approved
```
