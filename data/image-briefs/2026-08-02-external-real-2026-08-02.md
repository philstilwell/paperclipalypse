...
Run: 2026-08-02-external-real-2026-08-02
Winner: Claude Sonnet 4.6
Winning joke: Three Stars for the Metered Spots
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Three Stars for the Metered Spots
Exact joke text to render in the right panel:
I dated a food critic for two months. Ruined me. Now I can't do anything without narrating it in that voice. Found parking on level three of the garage downtown, and in my head I heard, 'A bold, confident space, though the concrete finish leaves something to be desired, and the ticket arrives underseasoned with hope.' I just wanted to park. She made me cry about a pillar.
...
Round seed terms for exclusion reference only: Military, Food Critic, Parking Garage / Lot, Being framed, Inspirational, Abrasive. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-02-external-real-2026-08-02.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-02.json --feature-image tmp/gemini-feature-images/2026-08-02-external-real-2026-08-02.jpg --feature-image-qa-approved
```
