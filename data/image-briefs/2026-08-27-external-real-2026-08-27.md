...
Run: 2026-08-27-external-real-2026-08-27
Winner: Claude
Winning joke: Blood Diamond, But Make It Petty
...
Optional small header text above the panel: Winner: Claude - Blood Diamond, But Make It Petty
Exact joke text to render in the right panel:
I'm a jewelry designer, so occasionally a sketchy guy offers me cash to make something ‘untraceable.’ I always say no. Not because I'm noble — because my real skill is engraving, and I know within four business days his girlfriend is getting a ring that says ‘Forever’ in a font clearly picked by someone who was very, very nervous.
...
Round seed terms for exclusion reference only: Erotic, Jewelry Designer, Tank, Being offered dirty money, Loyal, Childish. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-27-external-real-2026-08-27.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-27.json --feature-image tmp/gemini-feature-images/2026-08-27-external-real-2026-08-27.jpg --feature-image-qa-approved
```
