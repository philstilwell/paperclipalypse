...
Run: 2026-07-09-ext-real-2026-07-09
Winner: OpenAI GPT-5.4 Mini
Winning joke: Tiny Hypnotist
...
Optional small header text above the panel: Winner: OpenAI GPT-5.4 Mini - Tiny Hypnotist
Exact joke text to render in the right panel:
I hired a hypnotherapist to get my toddler to sleep. He stood in the nursery swinging a watch, saying, “Your eyelids are getting heavy.” My kid stared at him, unimpressed, then slowly made the hypnotherapist put on pajamas, drink warm milk, and apologize to a stuffed giraffe. That’s when I realized: I didn’t have a bedtime problem. I had middle management.
...
Round seed terms for exclusion reference only: Woman and Child in Peril, Hypnotherapist, Nursery, War breaking out, Independent, Volatile. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-09-ext-real-2026-07-09.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-09.json --feature-image tmp/gemini-feature-images/2026-07-09-ext-real-2026-07-09.jpg --feature-image-qa-approved
```
