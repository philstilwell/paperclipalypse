...
Run: 2026-08-11-external-real-2026-08-11
Winner: OpenAI GPT-5.4 Mini
Winning joke: Measure Twice
...
Optional small header text above the panel: Winner: OpenAI GPT-5.4 Mini - Measure Twice
Exact joke text to render in the right panel:
I worked construction for a while, but I was way too sensitive for it. My foreman kept saying, “Measure twice, cut once.” Everyone else heard practical advice. I heard, “Your first instinct is worthless, and frankly, we’ve discussed this.”
...
Round seed terms for exclusion reference only: Disaster, Teacher, Construction Site, Being thrust into the spotlight, Introverted, Oversensitive. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-11-external-real-2026-08-11.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-11.json --feature-image tmp/gemini-feature-images/2026-08-11-external-real-2026-08-11.jpg --feature-image-qa-approved
```
