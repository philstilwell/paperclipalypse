...
Run: 2026-07-08-ext-real-2026-07-08
Winner: Gemini Flash
Winning joke: Rugged Chassis
...
Optional small header text above the panel: Winner: Gemini Flash - Rugged Chassis
Exact joke text to render in the right panel:
I finally started seeing a therapist, which is tough when you're raised to be super macho. In our first session, she asked me to describe my feelings. I didn't have the emotional vocabulary, so I panicked and described a truck commercial. I squinted, lowered my voice, and said, 'Doc, I'm hauling a heavy payload on a rugged, steel-reinforced chassis.' She just nodded and diagnosed me with a Ford F-150.
...
Round seed terms for exclusion reference only: Paranormal, Therapist, Country Road, Experiencing a crisis of self-doubt, Empathetic, Macho. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-08-ext-real-2026-07-08.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file /Users/philstilwell/Documents/PAPERCLIPALYPSE/data/inbox/ext-real-2026-07-08.json --feature-image tmp/gemini-feature-images/2026-07-08-ext-real-2026-07-08.jpg --feature-image-qa-approved
```
