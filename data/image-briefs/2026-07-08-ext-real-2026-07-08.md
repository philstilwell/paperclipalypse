...
```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-08.json --feature-image tmp/gemini-feature-images/2026-07-08-ext-real-2026-07-08.jpg --feature-image-qa-approved
```
