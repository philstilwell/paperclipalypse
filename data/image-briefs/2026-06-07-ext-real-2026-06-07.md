...
Run: 2026-06-07-ext-real-2026-06-07
Winner: Claude Sonnet 4.6
Winning joke: Bone Dry
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Bone Dry
...
Seed terms for visual motifs: Sports, Palaeontologist, Waterfall, A fear or phobia rearing its head, Resourceful, Resentful.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-07-ext-real-2026-06-07.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-07.json --feature-image tmp/gemini-feature-images/2026-06-07-ext-real-2026-06-07.jpg --feature-image-qa-approved
```
