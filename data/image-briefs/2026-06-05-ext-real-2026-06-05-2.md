...
Run: 2026-06-05-ext-real-2026-06-05-2
Winner: Claude Sonnet 4.6
Winning joke: Cleared
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Cleared
Exact joke text to render in the right panel:
I finally worked up the nerve to ask out the woman I'd been making eyes at for three months. Leaned in, said, 'I'd really love to take you to dinner sometime.' She smiled — actually smiled — and then the security guard at the museum stepped between us. Turns out you're not allowed to talk to the paintings.
...
Seed terms for visual motifs: Monsters, Security Guard, Marina, Affection being stymied, Wise, Suspicious.
...
```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-05-2.json --feature-image /absolute/path/to/approved-image.png --feature-image-qa-approved
```
