...
Run: 2026-09-03-external-real-2026-09-03
Winner: Gemini Flash
Winning joke: The General
...
Optional small header text above the panel: Winner: Gemini Flash - The General
...
Round seed terms for exclusion reference only: Medical, Military Officer, Cafeteria, A dangerous crossing, Uninhibited, Tactless. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-03-external-real-2026-09-03.md
```

Read the generated `tmp/gemini-feature-images/2026-09-03-external-real-2026-09-03.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-03-external-real-2026-09-03.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-03.json --feature-image tmp/gemini-feature-images/2026-09-03-external-real-2026-09-03.jpg --feature-image-qa-approved
```
