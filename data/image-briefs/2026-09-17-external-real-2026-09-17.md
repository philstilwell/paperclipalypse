...
Run: 2026-09-17-external-real-2026-09-17
Winner: OpenAI GPT-5.6 Sol
Winning joke: The Shortcut
...
Optional small header text above the panel: Winner: OpenAI GPT-5.6 Sol - The Shortcut
Exact joke text to render in the right panel:
I sat beside a know-it-all on a bus who kept criticizing the driver’s route. Finally, the driver said, “Fine—you navigate.” Ten minutes later, we were wedged under a low bridge. As we crawled out the emergency exit, he whispered to me, “Still saved us two red lights.”
...
Round seed terms for exclusion reference only: Political, Writer, Bus, Taking advice from the wrong person, Independent, Know-It-All. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-17-external-real-2026-09-17.md
```

Read the generated `tmp/gemini-feature-images/2026-09-17-external-real-2026-09-17.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-17-external-real-2026-09-17.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-17.json --feature-image tmp/gemini-feature-images/2026-09-17-external-real-2026-09-17.jpg --feature-image-qa-approved
```
