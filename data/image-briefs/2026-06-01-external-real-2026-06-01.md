...
Run: 2026-06-01-external-real-2026-06-01
...
```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-06-01.json --feature-image /absolute/path/to/approved-image.png --feature-image-qa-approved
```
