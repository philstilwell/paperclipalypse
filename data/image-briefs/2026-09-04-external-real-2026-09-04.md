...
Run: 2026-09-04-external-real-2026-09-04
Winner: OpenAI GPT-5.6 Sol
Winning joke: Specific Reading
...
Optional small header text above the panel: Winner: OpenAI GPT-5.6 Sol - Specific Reading
...
Round seed terms for exclusion reference only: Organised Crime, Fortune Teller, Backyard, Losing a home / homeland, Introverted, Suspicious. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-04-external-real-2026-09-04.md
```

Read the generated `tmp/gemini-feature-images/2026-09-04-external-real-2026-09-04.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-04-external-real-2026-09-04.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-04.json --feature-image tmp/gemini-feature-images/2026-09-04-external-real-2026-09-04.jpg --feature-image-qa-approved
```
