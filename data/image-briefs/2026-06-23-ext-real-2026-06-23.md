...
Run: 2026-06-23-ext-real-2026-06-23
Winner: OpenAI GPT-5.4 Mini
Winning joke: Mirror Leverage
...
Optional small header text above the panel: Winner: OpenAI GPT-5.4 Mini - Mirror Leverage
Exact joke text to render in the right panel:
I got blackmailed at a carnival funhouse. They sent me a photo from the skinny mirror and said, "Pay up or we post this." I said, "Post it. That's the only picture where I look like I kept my New Year's resolution." Then they sent the wide-mirror photo, and I Venmoed them before the clown music looped.
...
Seed terms for visual motifs: Utopia, Assassin, Carnival Funhouse, Being blackmailed, Cooperative, Frivolous.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-23-ext-real-2026-06-23.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-23.json --feature-image tmp/gemini-feature-images/2026-06-23-ext-real-2026-06-23.jpg --feature-image-qa-approved
```
