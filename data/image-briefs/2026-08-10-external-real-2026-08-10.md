...
Run: 2026-08-10-external-real-2026-08-10
Winner: Claude Sonnet 4.6
Winning joke: High Roller
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - High Roller
...
Round seed terms for exclusion reference only: Gothic, Treasure Hunter, Casino, Being blackmailed, Perceptive, Obsessive. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-10-external-real-2026-08-10.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-10.json --feature-image tmp/gemini-feature-images/2026-08-10-external-real-2026-08-10.jpg --feature-image-qa-approved
```
