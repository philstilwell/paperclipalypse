...
Run: 2026-08-18-external-real-2026-08-18
Winner: Gemini Flash
Winning joke: The Cover Charge
...
Optional small header text above the panel: Winner: Gemini Flash - The Cover Charge
...
Round seed terms for exclusion reference only: Bio and Nanopunk, Party Planner, River / Creek, A prank going wrong, Bold, Extravagant. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-18-external-real-2026-08-18.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-18.json --feature-image tmp/gemini-feature-images/2026-08-18-external-real-2026-08-18.jpg --feature-image-qa-approved
```
