...
Run: 2026-09-21-external-real-2026-09-21
Winner: OpenAI GPT-5.6 Sol
Winning joke: Grace Period
...
Optional small header text above the panel: Winner: OpenAI GPT-5.6 Sol - Grace Period
Exact joke text to render in the right panel:
My six-year-old insisted on saying grace at dinner. He closed his eyes and said, “Dear God, thank you for Mommy, thank you for me, and please give Daddy the strength to finish his vegetables… because we’re not buying another shovel.”
...
Round seed terms for exclusion reference only: Creepy Kids, Deep Sea Diver, Science Laboratory, Having a one-night stand, Spiritual, Cruel. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-21-external-real-2026-09-21.md
```

Read the generated `tmp/gemini-feature-images/2026-09-21-external-real-2026-09-21.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-21-external-real-2026-09-21.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-21.json --feature-image tmp/gemini-feature-images/2026-09-21-external-real-2026-09-21.jpg --feature-image-qa-approved
```
