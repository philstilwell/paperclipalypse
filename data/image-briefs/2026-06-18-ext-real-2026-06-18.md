...
Run: 2026-06-18-ext-real-2026-06-18
Winner: Gemini Flash
Winning joke: Urban Tactical Fitness
...
Optional small header text above the panel: Winner: Gemini Flash - Urban Tactical Fitness
...
Seed terms for visual motifs: Crafts, Personal Trainer, Condemned Apartment Building, Rules changing, Happy, Martyr.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-18-ext-real-2026-06-18.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-18.json --feature-image tmp/gemini-feature-images/2026-06-18-ext-real-2026-06-18.jpg --feature-image-qa-approved
```
