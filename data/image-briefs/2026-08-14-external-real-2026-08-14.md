...
Run: 2026-08-14-external-real-2026-08-14
Winner: Claude Sonnet 5
Winning joke: Trail Mix-Up
...
Optional small header text above the panel: Winner: Claude Sonnet 5 - Trail Mix-Up
...
Round seed terms for exclusion reference only: Post-Apocalyptic, Animal Rescue Worker, Hiking Trail, A lie impacting someone else, Innocent, Fussy. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-14-external-real-2026-08-14.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-14.json --feature-image tmp/gemini-feature-images/2026-08-14-external-real-2026-08-14.jpg --feature-image-qa-approved
```
