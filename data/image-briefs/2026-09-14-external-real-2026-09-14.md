...
Run: 2026-09-14-external-real-2026-09-14
Winner: Claude
Winning joke: Assistant Coach
...
Optional small header text above the panel: Winner: Claude - Assistant Coach
...
Round seed terms for exclusion reference only: Sports, Stay at Home Parent, Office Cubicle, Having to rely on others, Empathetic, Inattentive. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-14-external-real-2026-09-14.md
```

Read the generated `tmp/gemini-feature-images/2026-09-14-external-real-2026-09-14.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-14-external-real-2026-09-14.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-14.json --feature-image tmp/gemini-feature-images/2026-09-14-external-real-2026-09-14.jpg --feature-image-qa-approved
```
