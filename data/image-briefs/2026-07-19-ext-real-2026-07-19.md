...
Run: 2026-07-19-ext-real-2026-07-19
Winner: Gemini Flash
Winning joke: Hotel Tantrum
...
Optional small header text above the panel: Winner: Gemini Flash - Hotel Tantrum
Exact joke text to render in the right panel:
I'm at that awkward level of success where I'm not quite rich and famous enough to throw a proper tantrum at a hotel front desk. I tried it last week. I slammed my hand down and yelled, "Do you have any idea who I am?!" The clerk just sighed, tapped his screen, and said, "Yeah, you're the guy whose debit card just declined for a mini-bar Toblerone."
...
Round seed terms for exclusion reference only: Rich and Famous, Talent Agent, Military Base, Lost temper / composure, Uninhibited, Callous. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-19-ext-real-2026-07-19.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-19.json --feature-image tmp/gemini-feature-images/2026-07-19-ext-real-2026-07-19.jpg --feature-image-qa-approved
```
