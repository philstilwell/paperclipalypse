...
Run: 2026-07-14-ext-real-2026-07-14
Winner: Gemini Flash
Winning joke: Polite Intoxication
...
Optional small header text above the panel: Winner: Gemini Flash - Polite Intoxication
Exact joke text to render in the right panel:
I am dangerously courteous when I'm drunk. Normal people get hammered and text their ex. I get blacked out and leave glowing Yelp reviews for ATMs. Last night I got so trashed I passed out on my neighbor’s front lawn. But I did it respectfully. I woke up curled in the fetal position, holding a handwritten sign that said, 'Please keep off the grass.'
...
Round seed terms for exclusion reference only: Blockbuster, Professor, Beach Party, Doing something stupid while drunk, Courteous, Grumpy. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-14-ext-real-2026-07-14.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-14.json --feature-image tmp/gemini-feature-images/2026-07-14-ext-real-2026-07-14.jpg --feature-image-qa-approved
```
