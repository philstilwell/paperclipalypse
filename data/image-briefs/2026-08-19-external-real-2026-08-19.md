...
Run: 2026-08-19-external-real-2026-08-19
Winner: Claude Sonnet 4.6
Winning joke: Doctor's Orders
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Doctor's Orders
Exact joke text to render in the right panel:
I trust doctors way too much. Any doctor. I went in for a routine checkup, guy I'd never met starts pressing on my stomach going 'does this hurt?' and I said 'a little' and he said 'good, means it's working,' and I just nodded like that was a sentence. He could've said 'we're removing your soul, insurance covers half,' and I'd have said thank you and asked if I could drive myself home.
...
Round seed terms for exclusion reference only: Medical, Stock Market Trader, Backyard, Being scammed, Trusting, Catty. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-19-external-real-2026-08-19.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-19.json --feature-image tmp/gemini-feature-images/2026-08-19-external-real-2026-08-19.jpg --feature-image-qa-approved
```
