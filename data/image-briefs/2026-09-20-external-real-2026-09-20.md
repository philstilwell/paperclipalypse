...
Run: 2026-09-20-external-real-2026-09-20
Winner: OpenAI GPT-5.6 Sol
Winning joke: Personal Best
...
Optional small header text above the panel: Winner: OpenAI GPT-5.6 Sol - Personal Best
Exact joke text to render in the right panel:
I discovered a dead body while jogging. The police asked why I looked so happy. I wasn’t—my fitness app had just announced, “Congratulations! You passed another runner.”
...
Round seed terms for exclusion reference only: Immortality, Bounty Hunter, Meadow, Discovering a dead body, Happy, Spoiled. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-20-external-real-2026-09-20.md
```

Read the generated `tmp/gemini-feature-images/2026-09-20-external-real-2026-09-20.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-20-external-real-2026-09-20.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-20.json --feature-image tmp/gemini-feature-images/2026-09-20-external-real-2026-09-20.jpg --feature-image-qa-approved
```
