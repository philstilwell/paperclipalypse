...
Run: 2026-07-27-ext-real-2026-07-27
Winner: Gemini Flash
Winning joke: Relationship Advice
...
Optional small header text above the panel: Winner: Gemini Flash - Relationship Advice
Exact joke text to render in the right panel:
I recently made the mistake of taking relationship advice from the guy who runs my local antiques store. I told him I was in a fight with my girlfriend and asked what I should buy her to smooth things over. He looked me dead in the eye and suggested a rusted nineteenth-century butter churn. It’s my own fault. The man’s entire livelihood relies on clinging to things that stopped working a hundred years ago, and I treated him like a couples counselor.
...
Round seed terms for exclusion reference only: Caper, Manual Labourer, Antiques Store, Taking advice from the wrong person, Funny, Disorganized. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-27-ext-real-2026-07-27.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-27.json --feature-image tmp/gemini-feature-images/2026-07-27-ext-real-2026-07-27.jpg --feature-image-qa-approved
```
