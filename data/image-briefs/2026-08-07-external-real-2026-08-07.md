...
Run: 2026-08-07-external-real-2026-08-07
Winner: Gemini Flash
Winning joke: Immersive Dining
...
Optional small header text above the panel: Winner: Gemini Flash - Immersive Dining
Exact joke text to render in the right panel:
I recently started dating a wealthy socialite, and she loves dragging me to these ultra-exclusive, immersive "farm-to-table" galas. It sounds incredibly elegant, but it’s really just a slaughterhouse with a strict dress code and a jazz quartet. I’m standing in mud in a rented tuxedo, nervously sipping champagne, while a sommelier named Tristan asks if I'd like to look my brisket in the eye.
...
Round seed terms for exclusion reference only: Outlaws, Socialite, Slaughterhouse, Chafing under poor leadership, Proper, Reckless. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-07-external-real-2026-08-07.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-07.json --feature-image tmp/gemini-feature-images/2026-08-07-external-real-2026-08-07.jpg --feature-image-qa-approved
```
