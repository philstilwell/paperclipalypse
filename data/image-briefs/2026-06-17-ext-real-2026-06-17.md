...
Run: 2026-06-17-ext-real-2026-06-17
Winner: Gemini Flash
Winning joke: People-Pleasing Hostage
...
Optional small header text above the panel: Winner: Gemini Flash - People-Pleasing Hostage
Exact joke text to render in the right panel:
I'm such a people-pleaser that if I ever end up being captured, I'm going to be a ridiculously hospitable hostage. I’ll be zip-tied to a radiator in a damp basement, my kidnapper will hand me a glass of tap water, and I’ll be like, 'Oh, you didn't need to use a coaster, it's just concrete! And honestly, the ropes are perfectly snug. I love what you've done with the murder room, by the way—is this real exposed brick?'
...
Seed terms for visual motifs: Master Detective, Private Detective, School Hallway, Being captured, Hospitable, Irresponsible.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-17-ext-real-2026-06-17.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-17.json --feature-image tmp/gemini-feature-images/2026-06-17-ext-real-2026-06-17.jpg --feature-image-qa-approved
```
