...
Run: 2026-07-06-ext-real-2026-07-06
Winner: Gemini Flash
Winning joke: Tummy-Time Latte
...
Optional small header text above the panel: Winner: Gemini Flash - Tummy-Time Latte
Exact joke text to render in the right panel:
I feel bad for the macho barista at my local coffee shop. He’s built like a lumberjack and covered in barbed-wire tattoos, but his entire job is aggressively making little treats. He looks like he should be bare-knuckle fighting a grizzly bear, but instead he’s staring me dead in the eyes, furiously shaking a carton of oat milk to make sure the microfoam on my iced lavender tummy-time latte is perfectly delicate.
...
Seed terms for visual motifs: Historical, Barista, Cruise Ship, Having to beat the clock, Talented, Macho.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-06-ext-real-2026-07-06.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-06.json --feature-image tmp/gemini-feature-images/2026-07-06-ext-real-2026-07-06.jpg --feature-image-qa-approved
```
