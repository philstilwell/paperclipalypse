...
Run: 2026-06-26-ext-real-2026-06-26
Winner: Claude Sonnet 4.6
Winning joke: Lucky Seat
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Lucky Seat
Exact joke text to render in the right panel:
I'm really superstitious at concerts. Like, embarrassingly superstitious. I won't move from the exact spot where the first song started — even if someone tall stands in front of me, even if I need the bathroom, even if my leg falls asleep. I stood completely still for three hours at a Radiohead show once. My chiropractor thinks I saw God. I did not see God. I saw Thom Yorke's left shoulder.
...
Seed terms for visual motifs: Mind Transfer, Military Officer, Concert, A difficult decision with no easy way, Playful, Superstitious.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-26-ext-real-2026-06-26.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-26.json --feature-image tmp/gemini-feature-images/2026-06-26-ext-real-2026-06-26.jpg --feature-image-qa-approved
```
