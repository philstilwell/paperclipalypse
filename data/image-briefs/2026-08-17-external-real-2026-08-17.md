...
Run: 2026-08-17-external-real-2026-08-17
Winner: Gemini Flash
Winning joke: A Little off the Top
...
Optional small header text above the panel: Winner: Gemini Flash - A Little off the Top
Exact joke text to render in the right panel:
Never walk into a hair salon and tell the stylist, 'I'm feeling spontaneous, just do whatever you want.' To me, 'spontaneous' means cutting off an extra half-inch. To a twenty-two-year-old stylist named Jax, 'spontaneous' means giving a grown man a bleached asymmetrical mullet. I didn't leave looking fresh and edgy. I left looking like I owe back child support in 1996.
...
Round seed terms for exclusion reference only: Comedy and Buddy, Personal Trainer, Hair Salon, Not achieving a coveted goal, Spontaneous, Humorless. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-17-external-real-2026-08-17.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-17.json --feature-image tmp/gemini-feature-images/2026-08-17-external-real-2026-08-17.jpg --feature-image-qa-approved
```
