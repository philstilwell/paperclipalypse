...
Run: 2026-09-09-external-real-2026-09-09
Winner: Claude
Winning joke: Chickpea Casualty
...
Optional small header text above the panel: Winner: Claude - Chickpea Casualty
...
Round seed terms for exclusion reference only: Holidays, Hypnotherapist, Grocery Store, Being unprepared, Ambitious, Fussy. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-09-external-real-2026-09-09.md
```

Read the generated `tmp/gemini-feature-images/2026-09-09-external-real-2026-09-09.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-09-external-real-2026-09-09.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-09.json --feature-image tmp/gemini-feature-images/2026-09-09-external-real-2026-09-09.jpg --feature-image-qa-approved
```
