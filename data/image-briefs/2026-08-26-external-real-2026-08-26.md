...
Run: 2026-08-26-external-real-2026-08-26
Winner: xAI Grok 4.3
Winning joke: Parking Spot Payback
...
Optional small header text above the panel: Winner: xAI Grok 4.3 - Parking Spot Payback
Exact joke text to render in the right panel:
I planned the perfect revenge on the guy who stole my parking spot. Key the car? Egg it? Leave a nasty note under the wiper? Being indecisive, I stood there fifteen minutes trying to decide. He came back, saw me hovering, and asked if I needed help finding my keys. Now he waves every time he sees me. My revenge is having to wave back like we're friends.
...
Round seed terms for exclusion reference only: Revenge, Socialite, Performing Arts Theater, A loved one being put in harm's way, Supportive, Indecisive. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-26-external-real-2026-08-26.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-26.json --feature-image tmp/gemini-feature-images/2026-08-26-external-real-2026-08-26.jpg --feature-image-qa-approved
```
