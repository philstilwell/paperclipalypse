...
Run: 2026-06-02-ext-real-2026-06-02
Winner: Gemini Flash
...
```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-02.json --feature-image /absolute/path/to/approved-image.png --feature-image-qa-approved
```
