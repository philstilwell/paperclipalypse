...
Run: 2026-07-25-ext-real-2026-07-25
Winner: Claude Sonnet 4.6
Winning joke: Return Policy
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Return Policy
...
Round seed terms for exclusion reference only: Blockbuster, Animal Rescue Worker, Factory, Being lied to, Affectionate, Morbid. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-25-ext-real-2026-07-25.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-25.json --feature-image tmp/gemini-feature-images/2026-07-25-ext-real-2026-07-25.jpg --feature-image-qa-approved
```
