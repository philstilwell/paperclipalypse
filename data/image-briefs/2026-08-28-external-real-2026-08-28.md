...
Run: 2026-08-28-external-real-2026-08-28
Winner: Claude
Winning joke: Custody of the Cooler
...
Optional small header text above the panel: Winner: Claude - Custody of the Cooler
Exact joke text to render in the right panel:
My buddy went to the bathroom at a baseball game and made me hold his nachos, his phone, his kid, and his seat. In that order of importance, apparently, because when the kid wandered off I didn’t even notice for ten minutes — I was busy protecting the nachos with my life. Found out that day I’d die for cheese sauce before I’d die for eye contact with a toddler.
...
Round seed terms for exclusion reference only: Legal, Business Tycoon, Sporting Event Stands / Bleachers, Being saddled with responsibility, Pensive, Foolish. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-08-28-external-real-2026-08-28.md
```

Read the generated `tmp/gemini-feature-images/2026-08-28-external-real-2026-08-28.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-28-external-real-2026-08-28.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-28.json --feature-image tmp/gemini-feature-images/2026-08-28-external-real-2026-08-28.jpg --feature-image-qa-approved
```
