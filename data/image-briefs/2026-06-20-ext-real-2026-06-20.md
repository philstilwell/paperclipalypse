...
Run: 2026-06-20-ext-real-2026-06-20
Winner: OpenAI GPT-5.4 Mini
Winning joke: Spare Key
...
Optional small header text above the panel: Winner: OpenAI GPT-5.4 Mini - Spare Key
Exact joke text to render in the right panel:
I found out my ex moved on when I went to return her spare key and there was already a locksmith changing the locks. That hurt. Not because she didn’t trust me—because he looked at the key, looked at me, and said, “Don’t worry, this one hasn’t worked here in a long time.”
...
Seed terms for visual motifs: Sports, Locksmith, Antiques Store, A love interest moving on, Objective, Martyr.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-20-ext-real-2026-06-20.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-20.json --feature-image tmp/gemini-feature-images/2026-06-20-ext-real-2026-06-20.jpg --feature-image-qa-approved
```
