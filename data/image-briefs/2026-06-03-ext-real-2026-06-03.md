...
Run: 2026-06-03-ext-real-2026-06-03
Winner: Gemini Flash
...
```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-03.json --feature-image /absolute/path/to/approved-image.png --feature-image-qa-approved
```
