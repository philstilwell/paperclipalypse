...
Run: 2026-08-21-external-real-2026-08-21
Winner: Gemini Flash
Winning joke: Haunted Roommate
...
Optional small header text above the panel: Winner: Gemini Flash - Haunted Roommate
...
Round seed terms for exclusion reference only: Paranormal, Model, Canyon, Running out of critical supplies, Trusting, Evasive. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-21-external-real-2026-08-21.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-21.json --feature-image tmp/gemini-feature-images/2026-08-21-external-real-2026-08-21.jpg --feature-image-qa-approved
```
