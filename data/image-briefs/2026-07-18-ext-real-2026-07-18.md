...
Run: 2026-07-18-ext-real-2026-07-18
Winner: Gemini Flash
Winning joke: The Interrogation
...
Optional small header text above the panel: Winner: Gemini Flash - The Interrogation
...
Round seed terms for exclusion reference only: Blockbuster, Professor, Police Station, Having to betray someone, Confident, Grumpy. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-18-ext-real-2026-07-18.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-18.json --feature-image tmp/gemini-feature-images/2026-07-18-ext-real-2026-07-18.jpg --feature-image-qa-approved
```
