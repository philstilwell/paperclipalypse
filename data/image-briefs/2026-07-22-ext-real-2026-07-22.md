...
Run: 2026-07-22-ext-real-2026-07-22
Winner: Claude Sonnet 4.6
Winning joke: First Recital
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - First Recital
...
Round seed terms for exclusion reference only: Fairy Tale, Dancer, Funeral Home, A difficult decision with no easy way, Discreet, Possessive. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-22-ext-real-2026-07-22.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-22.json --feature-image tmp/gemini-feature-images/2026-07-22-ext-real-2026-07-22.jpg --feature-image-qa-approved
```
