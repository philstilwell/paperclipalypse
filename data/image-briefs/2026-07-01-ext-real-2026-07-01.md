...
Run: 2026-07-01-ext-real-2026-07-01
Winner: Claude Sonnet 4.6
Winning joke: Family Discount
...
Optional small header text above the panel: Winner: Claude Sonnet 4.6 - Family Discount
...
Seed terms for visual motifs: Organised Crime, Private Detective, Graveyard / Mausoleum, Sacrifice one for the many, Spiritual, Prejudiced.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-01-ext-real-2026-07-01.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-01.json --feature-image tmp/gemini-feature-images/2026-07-01-ext-real-2026-07-01.jpg --feature-image-qa-approved
```
