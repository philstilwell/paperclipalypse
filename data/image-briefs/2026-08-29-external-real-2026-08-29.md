...
Run: 2026-08-29-external-real-2026-08-29
Winner: Copilot
Winning joke: Blueprints
...
Optional small header text above the panel: Winner: Copilot - Blueprints
Exact joke text to render in the right panel:
I tried to help my friend with a tiny zoning issue, because I’m an architect and figured, how hard could it be? Five minutes later I’m in a conference room, accidentally giving legal advice. The lawyer leans over and whispers, “You can’t say any of that.” I said, “Why not? It worked great on my last building.” He said, “Yeah, but buildings don’t sue.”
...
Round seed terms for exclusion reference only: Legal, Architect, Desert / Badlands, Being offered an easy way out, Empathetic, Tactless. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-08-29-external-real-2026-08-29.md
```

Read the generated `tmp/gemini-feature-images/2026-08-29-external-real-2026-08-29.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-08-29-external-real-2026-08-29.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-08-29.json --feature-image tmp/gemini-feature-images/2026-08-29-external-real-2026-08-29.jpg --feature-image-qa-approved
```
