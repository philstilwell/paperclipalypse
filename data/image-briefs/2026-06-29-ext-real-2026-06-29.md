...
Run: 2026-06-29-ext-real-2026-06-29
Winner: Gemini Flash
Winning joke: The Anniversary Vase
...
Optional small header text above the panel: Winner: Gemini Flash - The Anniversary Vase
Exact joke text to render in the right panel:
I’m incredibly stingy. I refused to pay eighty bucks for a vase for my wife’s birthday, so I decided to take up glassblowing and just make her one. It’s been two years. I’ve spent fifteen thousand dollars on a blast furnace in the garage, I have absolutely no eyebrows left, and I just handed her something that looks exactly like a melted Jolly Rancher.
...
Seed terms for visual motifs: Historical, Glassblower / Potter, Truck Stop, Forced attendance, Perceptive, Stingy.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-29-ext-real-2026-06-29.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-29.json --feature-image tmp/gemini-feature-images/2026-06-29-ext-real-2026-06-29.jpg --feature-image-qa-approved
```
