...
Run: 2026-07-15-ext-real-2026-07-15
Winner: Gemini Flash
Winning joke: Open Floor Plan
...
Optional small header text above the panel: Winner: Gemini Flash - Open Floor Plan
Exact joke text to render in the right panel:
My girlfriend is incredibly spoiled. She thinks "camping" is when the hotel WiFi drops to two bars. To give her some perspective, I took her to visit my brother on his military base. We were walking through the barracks, staring at the endless rows of miserable, tightly-made cots. She gasped in horror, clutched my arm, and whispered, "Oh my god... an open floor plan?"
...
Round seed terms for exclusion reference only: Historical, Model, Military Base, Confiding in the wrong person, Patient, Spoiled. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-15-ext-real-2026-07-15.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-15.json --feature-image tmp/gemini-feature-images/2026-07-15-ext-real-2026-07-15.jpg --feature-image-qa-approved
```
