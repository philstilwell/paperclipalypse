...
Run: 2026-09-18-external-real-2026-09-18
Winner: Copilot
Winning joke: Five-Star Lunch
...
Optional small header text above the panel: Winner: Copilot - Five-Star Lunch
...
Round seed terms for exclusion reference only: Politics-Focused, Food Critic, Cafeteria, Being mistaken for someone else, Spunky, Volatile. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-18-external-real-2026-09-18.md
```

Read the generated `tmp/gemini-feature-images/2026-09-18-external-real-2026-09-18.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-18-external-real-2026-09-18.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-18.json --feature-image tmp/gemini-feature-images/2026-09-18-external-real-2026-09-18.jpg --feature-image-qa-approved
```
