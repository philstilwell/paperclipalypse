...
Run: 2026-06-22-ext-real-2026-06-22
Winner: Gemini Flash
Winning joke: Hide and Seek
...
Optional small header text above the panel: Winner: Gemini Flash - Hide and Seek
Exact joke text to render in the right panel:
Hide and seek is wild. Most kids just cover their eyes in the middle of the grass and think they're invisible. But there’s always that one six-year-old who treats the playground like he's a trained assassin. He doesn't just hide; he burrows into the mulch to erase his heat signature. I was just trying to read on a bench when he dropped silently from the monkey bars, handed me a crushed juice box, and whispered, 'The slide is compromised.'
...
Seed terms for visual motifs: Family and Friendship, Assassin, Playground, War breaking out, Ambitious, Addictive.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-22-ext-real-2026-06-22.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-22.json --feature-image tmp/gemini-feature-images/2026-06-22-ext-real-2026-06-22.jpg --feature-image-qa-approved
```
