...
Run: 2026-09-25-external-real-2026-09-25
Winner: Claude
Winning joke: Cheat Day Forever
...
Optional small header text above the panel: Winner: Claude - Cheat Day Forever
Exact joke text to render in the right panel:
I fired my dietician. Not because the diet failed — because I found out she went home and told her husband about my cheat days. Like it was gossip. Ma'am, I trusted you with my macros and my dignity, and you sold me out for dinner conversation. I've forgiven exes, forgiven my dad, forgiven a guy who backed into my car and drove off. But her? Never. I will hold this grudge with the same discipline I never once held a diet.
...
Round seed terms for exclusion reference only: Urban, Dietician, Vegas Stage Show, Being unable to forgive someone, Spontaneous, Humorless. These are not scene ingredients unless the winning joke explicitly uses them.
...
```sh
node scripts/prepare-feature-image-prompt.mjs --brief data/image-briefs/2026-09-25-external-real-2026-09-25.md
```

Read the generated `tmp/gemini-feature-images/2026-09-25-external-real-2026-09-25.prompt.txt` file directly when filling Gemini's composer.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-09-25-external-real-2026-09-25.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/external-real-2026-09-25.json --feature-image tmp/gemini-feature-images/2026-09-25-external-real-2026-09-25.jpg --feature-image-qa-approved
```
