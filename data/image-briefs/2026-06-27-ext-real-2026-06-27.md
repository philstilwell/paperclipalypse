...
Run: 2026-06-27-ext-real-2026-06-27
Winner: Gemini Flash
Winning joke: Nourishment Acquired
...
Optional small header text above the panel: Winner: Gemini Flash - Nourishment Acquired
Exact joke text to render in the right panel:
We hired a new nanny, and she’s great, but whenever I ask about my toddler's day, she gets incredibly evasive. I’ll ask, 'Hey, did Tommy eat his lunch?' and she’ll stare at the floor and whisper, 'Mistakes were made, but nourishment was acquired.' Like, okay, Mary Poppins, did he actually eat a sandwich, or did he spend the entire afternoon in the backyard eating handfuls of premium mulch?
...
Seed terms for visual motifs: Steampunk, Nanny, Limousine, A health issue cropping up, Confident, Evasive.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-06-27-ext-real-2026-06-27.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-06-27.json --feature-image tmp/gemini-feature-images/2026-06-27-ext-real-2026-06-27.jpg --feature-image-qa-approved
```
