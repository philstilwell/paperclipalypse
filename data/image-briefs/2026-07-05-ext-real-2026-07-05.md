...
Run: 2026-07-05-ext-real-2026-07-05
Winner: Gemini Flash
Winning joke: Tactical DJ
...
Optional small header text above the panel: Winner: Gemini Flash - Tactical DJ
Exact joke text to render in the right panel:
I went to a shooting range to feel tough, but it just sent me into a massive crisis of self-doubt. It’s impossible to feel like John Wick when you're wearing rented safety goggles over your prescription glasses and bright neon earmuffs that make you look like a tactical DJ. I paid fifty bucks just to violently flinch at my own weapon, miss a stationary piece of paper, and instinctively whisper, 'My bad,' every time I pulled the trigger.
...
Seed terms for visual motifs: Whodunit, Nanny, Shooting Range, Experiencing a crisis of self-doubt, Disciplined, Martyr.
...
```sh
node scripts/qa-feature-image.mjs --image tmp/gemini-feature-images/2026-07-05-ext-real-2026-07-05.jpg --approved
```

After visual approval, render the episode with the approved preview image:

```sh
node scripts/run-tournament.mjs --episode-file data/inbox/ext-real-2026-07-05.json --feature-image tmp/gemini-feature-images/2026-07-05-ext-real-2026-07-05.jpg --feature-image-qa-approved
```
